...
export function ReferralSideRibbon() {
  ...
  return (
    <Link
      ...
      className="referral-side-ribbon flex fixed right-0 z-40 items-center gap-1.5 rounded-l-lg bg-gold text-primary shadow-lg hover:bg-gold/90 transition-colors [writing-mode:vertical-rl] font-semibold uppercase top-28 md:top-24 px-1.5 py-2 md:px-3 md:py-4 text-[10px] md:text-xs tracking-[0.15em] md:tracking-[0.25em]"
    >
